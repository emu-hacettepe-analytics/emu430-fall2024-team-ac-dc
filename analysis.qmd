...
A notable differentiation in charging strategy is observed among the leading operators.Voltrun is the most AC focused operator, with a 90% AC share. This AC-oriented struc ture can be partly explained by the fact that approximately X% of Voltrun’s sockets are private/restricted, indicating a stronger focus on destination based and controlled access charging locations rather than public highway fast charging. In contrast, Trugo, with an 81% DC share, has established a fast-charging network primarily targeting highway and intercity travelers. This DC oriented structure is also consistent with Trugo’s socket portfolio, as approximately X% of its sockets are publicly accessible, supporting its nation wide corridor-based charging strategy. Similarly, eŞarj with 84% DC and Astor with 78% DC also show a strong fast-charging focus. ZES, on the other hand, adopts a approach serving both urban and highway needs, with a 48% DC share.
...
print(p4)
```
<p style="text-align:center;"><strong>Figure 10:</strong> Socket Distribution by City- Top 8 Cities for Each of the Top 5 Brands
(EMRA, April 2026)</p
